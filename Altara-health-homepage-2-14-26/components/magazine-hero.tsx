...
function ArticleCard({ image, title, author, className = "" }: ArticleCardProps) {
...
function SidebarArticle({ image, title, author }: SidebarArticleProps) {
  const [isHovered, setIsHovered] = useState(false);
...
function AuroraBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Blob 1 - Teal, top-left to center */}
      <motion.div
      ...
      />
      {/* Blob 2 - Sand, bottom-right to center */}
      <motion.div
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="bg-[#bbc7a4] text-[#1a2e3e] px-4 py-2 text-sm font-medium rounded-sm hover:bg-[#bbc7a4]/85 transition-colors">
                  Sign up
                </button>
              </div>
