    ...
    <section className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <button className="mt-4 md:mt-0 bg-[#bb4430] text-white border border-[#bb4430] px-6 py-3 rounded-full text-sm font-medium hover:bg-[#bb4430]/85 transition-colors shimmer-cta">
            Get Started
          </button>
        </motion.div>
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              ...
              <button className="text-sm font-medium text-[#1a2e3e] bg-[#bbc7a4] rounded-full px-4 py-2.5 hover:bg-[#bbc7a4]/85 transition-colors w-full mt-6">
                {step.cta}
              </button>
            </motion.div>
          ))}
