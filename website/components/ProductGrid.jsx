        ...
        >
          {products.map((product) => (
            <motion.div
              ...
              className="bg-black/[0.04] backdrop-blur-sm border border-white/40 rounded-lg p-6 cursor-pointer group shadow-md min-w-[280px] md:min-w-0 snap-center flex-shrink-0 md:flex-shrink"
